...
let searchingKeyword = 'automation'
...
describe('list-view-patients', () => {
  ...
  it('should display detail view', async () => {
    ...
    await page.waitForSelector('[data-testid="patient-mrn-value"]')
    let actualMRN = await page.innerText('[data-testid="patient-mrn-value"]')
